...
/***/ function(module, exports, __webpack_require__) {
	...
	function listenForCredentials(endpointKey, popup, provider, resolve, reject) {
	  if (!resolve) {
	    ...
	    if (creds && creds.uid) {
	      ...
	      (0, _fetch2.default)((0, _sessionStorage.getTokenValidationPath)(endpointKey)).then(_handleFetchResponse.parseResponse).then(function (users) {
	...
	function authenticate(_ref2) {
	  var endpointKey = _ref2.endpointKey;
	  var provider = _ref2.provider;
	  var url = _ref2.url;
	  var _ref2$tab = _ref2.tab;
	  var tab = _ref2$tab === undefined ? false : _ref2$tab;
